...
export const defaultSections: ReportSections = {
  ...
  instagram: {
    ...
    bio: { whatDoes: null, whereOperates: null, authority: null, cta: null, linkInBio: null, linkTracking: null },
...
export const sampleSections: ReportSections = {
  ...
  instagram: {
    ...
    bio: { whatDoes: 'ok', whereOperates: 'ok', authority: 'nok', cta: 'nok', linkInBio: 'ok', linkTracking: false },
